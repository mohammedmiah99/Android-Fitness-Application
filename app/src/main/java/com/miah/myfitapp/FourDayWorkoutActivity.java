...
public class FourDayWorkoutActivity extends AppCompatActivity {

    private ImageView btnWorkout1, btnWorkout2, btnWorkout3,btnWorkout4, btnback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_day_workout);
