...
public class FiveDayWorkoutActivity extends AppCompatActivity {

    private ImageView btnWorkout1, btnWorkout2, btnWorkout3,btnWorkout4,btnWorkout5, btnback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_five_day_workout);
        ...
        btnWorkout4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intToMain = new Intent(getApplicationContext(), UpperWrktActivity.class);
                startActivity(intToMain); }
        });
